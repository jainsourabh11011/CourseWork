---
title: "Multidimensional Scaling with R"
output: html_document
---

See http://www.r-statistics.com/2016/01/multidimensional-scaling-with-r-from-mastering-data-analysis-with-r/
...
How to render this plot with the new version of ggplot2 to avoid overlaps in the city names and suppressing the not that useful x andy axis labels and ticks:
```{r message=FALSE}
library(ggplot2)
