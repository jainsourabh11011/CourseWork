---
title: "ISLR - Ch 9 - Support Vector Machines"
output: html_document
---
##9.6.1  Support Vecor Classifier
...
In order to fit an SVMusing a non-linear kernel, we once again use the svm()
...
X = (X1,X2, . . .,Xp)T takes the form ˆ β0 + ˆ β1X1 + ˆ β2X2 + . . . + ˆβpXp.
