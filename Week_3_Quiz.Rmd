...
library(caret)
library(rpart)
library(rattle) #for the nice looking trees
```
...
1. TotalIntench2 = 23,000; FiberWidthCh1 = 10; PerimStatusCh1=2       PS  
2. TotalIntench2 = 50,000; FiberWidthCh1 = 10;VarIntenCh4 = 100       WS  
3. TotalIntench2 = 57,000; FiberWidthCh1 = 8;VarIntenCh4 = 100        PS  
4. FiberWidthCh1 = 8;VarIntenCh4 = 100; PerimStatusCh1=2              Not possible to predict
...
```{r}
rm(list=ls())
library(pgmm) #provides the olive dataset
data(olive)
olive = olive[,-1]
```
