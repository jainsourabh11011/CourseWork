...
source(file = "05_Evaluation/expected_value_targeted_OT_policy_ch7.R")
...
rates_by_threshold_optimized_tbl_3 %>%
    ...
    labs(
        title = glue::glue("Optimization Results: Expected Savings Maximized at {max_f1_tbl$threshold * 100}"),
...
# If an employee liklihood to leave > threshold.  Recall Stock Option Cost is the value required to move 
